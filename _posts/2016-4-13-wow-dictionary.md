...
Split latin words is easy. It won't be more than 5 lines of code ([ref](http://stackoverflow.com/questions/236129/split-a-string-in-c#adzerk342792211)). It is hard to split chinese words. Billions of chinese Ph.D students graduates each year, by spamming all kinds of word segmentation methods.

We need a dictionary before doing word segmentation. A dictionary for WoW.
